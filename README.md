...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://okatsn.github.io/OkTableTools.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://okatsn.github.io/OkTableTools.jl/dev/)
[![Build Status](https://github.com/okatsn/OkTableTools.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/okatsn/OkTableTools.jl/actions/workflows/CI.yml?query=branch%3Amain)
[![Coverage](https://codecov.io/gh/okatsn/OkTableTools.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/okatsn/OkTableTools.jl)
...
!!! note Checklist
    - [x] Create an empty repository (namely, `https://github.com/okatsn/OkTableTools.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
...
### Auto-Registration
- You have to add `ACCESS_OKREGISTRY` to the secret under the remote repo (e.g., https://github.com/okatsn/OkTableTools.jl).
...
Connect to remote:
1. Switch to the local directory of this project (OkTableTools)
2. Add an empty repo OkTableTools(.jl) on github (without anything!)
...
This package is create on 2023-03-27.
